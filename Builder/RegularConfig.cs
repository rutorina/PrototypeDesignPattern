...
namespace Builder
{
    public class RegularConfig : Builder
    {
        ...
        {
            config.GPU = "Asus DUAL OC GeForce RTX 2070 Ti 8 GB Video Card";
            logger.Log($"GPU set to {config.GPU}");
        }
        public override void setCPU()
        {
            config.CPU = "Intel Core i7-12700K 3.6 GHz 12-Core Processor";
            logger.Log($"CPU set to {config.CPU}");
        }
        public override void setRam()
        {
            config.RAM = "Corsair Vengeance 16 GB (2 x 8 GB) DDR5-5200 CL40 Memory";
        ...
        {
            config.MB = "Gigabyte Z790 AORUS ELITE AX ATX LGA1700 Motherboard";
        ...
        {
            config.picture = Image.FromFile(@"E:\!College\KPZ\BuilderDesignPattern\BuilderDesignPattern\images\regular.jpg");
            logger.Log($@"picture set to E:\!College\KPZ\BuilderDesignPattern\BuilderDesignPattern\images\regular.jpg");
        ...
        public override CS Build()
        {
            ...
            setPW();
            setPicture();
            logger.Log("Regular config was built successfully");
            logger.ShowLogs();
            return config;
        }
    }
